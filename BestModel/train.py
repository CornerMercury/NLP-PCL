...
# This watches the checkpoints and deletes the bad ones to save disk space
class KeepBestCheckpointCallback(TrainerCallback):
    ...
    def on_save(self, args, state, control, **kwargs):
        ...
        # list of all current checkpoint folders on disk
...
trainer = FocalLossTrainer(
    ...
    callbacks=[KeepBestCheckpointCallback()]
)
